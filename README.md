...
This repository is the SWT ViewBot fork of JijaProGamer Bloxxy’s project. This fork removes the password gateway and bypasses some API requirements to enable testing. For testing use only — not for production.

GitHub Fork: https://github.com/veracitylife/ViewBot  
SWT Discord Server: https://discord.gg/GCa9zS7j
